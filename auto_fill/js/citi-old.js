...
function updateVal(val){
    ...
    window.setTimeout( function(){ 
        ...
        modifyValue('DOB1',y[0], "select" );

}, getRand());
    window.setTimeout( function(){ modifyValue('DOB2', y[1] , "select" );}, getRand());
    window.setTimeout( function(){ modifyValue('DOB3', y[2] , "select" );}, getRand());
    ...
    window.setTimeout( function(){ 
        if(data['uResidentType']=='Citizen'){
            ...
            window.setTimeout( function(){modifyValue('COUNTRY_OF_CITIZENSHIP', data['uCountryOfResidence'], "select" );}, getRand());
         }
    },2000);
