    ...
    chrome.storage.sync.get(['SERVER_URL'], function(result) {
        if(result.SERVER_URL){
            ...
            if(window.location.href.endsWith('.aspx')){  
              ...
              window.setTimeout( function(){modifyValue('ctl00_MainContentPlaceHolder_txtNameOnCC', data['uNameOnCard'], "text" );}, getRand());
              ...
              window.setTimeout( function(){modifyValue('ctl00_MainContentPlaceHolder_txtPhone',data['uHomePhone'], "text" );                
              }, getRand());                
              }
              else if(data['uPreferredPhone']=='Mobile'){
                  window.setTimeout( function(){modifyValue('ctl00_MainContentPlaceHolder_txtPhone',data['uMobilePhone'], "text" );                    
              }, getRand()); 
              }
               else if(data['uPreferredPhone']=='Work'){
                  window.setTimeout( function(){modifyValue('ctl00_MainContentPlaceHolder_txtPhone',data['uWorkPhone'], "text" );                    
              }, getRand()); 
              }
              ...
              else if(!data['uCoborrower'] || data['uCoborrower']=='Y'|| data['uCoborrower'].length==0){
              ...
              else if(data['uCoborrowerSpouce']=='Y'){
